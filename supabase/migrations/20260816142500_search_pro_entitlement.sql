...
-- Pro-only analytics: public search still works, but analytics are collected only for contracted tenants.
...
-- Autocomplete is Pro-only at the database boundary, not merely hidden in UI.
