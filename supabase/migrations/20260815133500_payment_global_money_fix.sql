...
begin
 ...
 if o.grand_total::numeric(20,4)<>t.amount::numeric(20,4) or upper(o.currency)<>upper(t.currency) then raise exception 'payment_amount_mismatch';end if;
 ...
 insert into public.payment_events(tenant_id,transaction_id,event_type,payload) values(t.tenant_id,t.id,'payment.verified',jsonb_build_object('order_id',o.id,'amount',t.amount,'currency',upper(t.currency)));
end$$;
