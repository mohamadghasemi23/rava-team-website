...
export default async function AdminPage() {
  ...
  const [projects, services, newLeads, media, todayViews, weekViews, monthViews] = await Promise.all([
    ...
    supabase.from('page_views_daily').select('views').gte('day', isoDay(thirtyDaysAgo)),
  ])
  ...
  return <main className="admin-shell">
    ...
    <section className="admin-stats" aria-label="آمار سایت">
      ...
      <article><span>۳۰ روز اخیر</span><b>{sumViews(monthViews.data)}</b><small>بازدید</small></article>
