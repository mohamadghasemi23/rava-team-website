...
1. Capture and inspect the latest RAVA-specific Hero plus optical Navbar/Mega Menu at desktop and mobile widths; fix measured defects, then establish an owner-approved revised Comp D authority and pass the Hero Gate without weakening its threshold.
