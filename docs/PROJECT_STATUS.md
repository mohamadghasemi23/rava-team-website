...
1. Validate and commit the approved V4.1 Hero polish, then run all GitHub Gates without deploying it.
2. Capture and compare the coded V4.1 Hero with the approved desktop/mobile/hover references; obtain explicit implementation acceptance before another Staging deployment.
