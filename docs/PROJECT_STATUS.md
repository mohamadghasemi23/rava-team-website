...
1. Prepare and obtain owner approval for exact mobile and open-navigation adaptations of the approved interactive Hero base; then replace obsolete Living System imagery and consolidate conflicting Hero/Navbar/Journey CSS.
