...
1. Obtain owner approval for the exact desktop/mobile open-navigation states of the approved interactive Hero base; then replace obsolete Living System imagery and consolidate conflicting Hero/Navbar/Journey CSS.
